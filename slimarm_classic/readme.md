# slimarm classic(us3c): bare-metal code execution and Linux research on S3C2410AL
...
```
- --
<b>Note: content following need to be updated. Do not follow these instructions as references.</b>
- --
...
Note: This project is now testing the new designed core board `slimarm classic` with:<br>
* 32 MBytes SDRAM(tuned line length)
* 32 MBytes NAND flash(nand boot)
* SD card slot(tuned line length)

<img src="jlcA2S3TTYCEUD5top-4480x3200.png" width=400 />
...
7. When soldering S3C2410 onto the board, <b>DO NOT heat over 320 C degrees</b>, or the chip will be damaged, especially malfunctioning on bus operation, which will not pass the DRAM read/write test.
- --
...
checkout <a href="slimarm_classic.cfg">slimarm_classic.cfg</a>
- --
